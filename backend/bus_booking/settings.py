...
SECRET_KEY = 'django-insecure-wu@lfpw##tz9r_z6)tavx=8&t^_fxm9o$03r@=+kzvlv5@h2du'
...
# CORS Configuration
CORS_ALLOW_ALL_ORIGINS = True # In a production environment, this should list specific frontend domains.
